<?php
	...
	try{
		...
		if ($stmt->execute(array(':id_no' => $_POST['id_no'] , ':firstname' => $_POST['firstname'] , ':lastname' => $_POST['lastname'] , ':middlename' => $_POST['middlename'] , ':gender' => $_POST['gender'] , ':office_id' => $_POST['department'] , ':campus_id' => $_POST['campus'] , ':role_id' => $_POST['role'] , ':contact' => $_POST['contact'] , ':email' => $_POST['email'] , ':username' => $_POST['username'] , ':password' => $_POST['password'])) ){
